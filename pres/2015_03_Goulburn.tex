...
\begin{itemize}
\item No restriction on graphical structure.
...
\end{tikzpicture}
\caption{Chains}\label{fig:exchangeable}
\end{center}
\end{figure}
...
Available building blocks: $C_{11}(\cdot,\cdot)$, $C_{2\mid 1}(\cdot,\cdot)$, $b(\cdot,\cdot)$.
...
\vspace{-0.3cm}
Available building blocks: $C_{11}(\cdot,\cdot)$, $C_{2\mid 1}(\cdot,\cdot)$, $C_{3|1,2}(\cdot,\cdot)$, $b_{21}(\cdot,\cdot)$, $b_{31}(\cdot,\cdot)$, $b_{32}(\cdot,\cdot)$.

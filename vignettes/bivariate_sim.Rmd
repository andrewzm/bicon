...
```{r,fig.cap='The correlation and cross-correlation functions estimated using Model 4, depicted as a function of displacement $h$ in degrees latitude/longitude, at the point $s = (-123,45)$. Contour lines denote intervals of 0.2.'}
